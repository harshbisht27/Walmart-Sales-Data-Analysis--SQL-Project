...
'/Users/harshbisht/Documents/Walmart Sales Data.csv'
INTO TABLE sales
...
SELECT product_line, COUNT(product_line) as Most_selling from sales group by product_line order by most_selling DESC limit 1;
